...
const Land_1 = () => {
  ...
  const images = [
    "/images/Rectangle 52.jpg",
    "/images/Rectangle 53.jpg",
    "/images/Rectangle 54.jpg",
  ];
...
>
At Kandalama Homes, we believe in transforming outdoor spaces into breathtaking landscapes 
that harmonize with Sri Lanka’s natural beauty. Our expert landscape architects specialize in 
creating serene, sustainable, and functional environments for residential and commercial projects,
 blending modern design principles with the island's lush tropical charm.
</motion.p>
